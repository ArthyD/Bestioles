...
test : testBench.cpp Aquarium.o Bestiole.o  BestiolePeureuse.o BestioleGregaire.o BestiolePrevoyante.o BestioleKamikaze.o BestioleFactory.o Milieu.o Control.o
	g++ -Wall -std=c++11 -o test testBench.cpp Aquarium.o Bestiole.o BestiolePeureuse.o BestioleGregaire.o BestiolePrevoyante.o BestioleKamikaze.o BestioleFactory.o Milieu.o Control.o -I . -lX11 -lpthread
